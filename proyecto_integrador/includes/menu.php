...
if ($rol === 'administrador') {
    $menuItems = [
        ...
        ['url' => 'views/calificaciones/reporte.php', 'icon' => 'bi-bar-chart', 'text' => 'Reportes'],
    ];
}
// Menú para Maestro
elseif ($rol === 'maestro') {
...
elseif ($rol === 'estudiante') {
    $menuItems = [
        ...
        ['url' => 'views/materias_disponibles.php', 'icon' => 'bi-book', 'text' => 'Materias Disponibles'],
        ['url' => 'views/mis_inscripciones.php', 'icon' => 'bi-journal-bookmark', 'text' => 'Mis Inscripciones'],
