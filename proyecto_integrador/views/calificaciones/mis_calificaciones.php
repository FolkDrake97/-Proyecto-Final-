 ...
 * Archivo: views/calificaciones/mis_calificaciones.php
 */
                ...
                <?php else: ?>
                    <div class="list-group list-group-flush">
                        <?php foreach ($promediosMaterias as $materia): 
                            ...
                            $clase = is_numeric($promedio) ? claseCalificacion($promedio) : 'secondary';
                        ?>
                            <div class="list-group-item">
                                <div class="d-flex w-100 justify-content-between align-items-center">
                                    ...
                                    <span class="calificacion <?php echo $clase; ?>">
                                        <?php echo $promedio; ?>
                                    </span>
                                </div>
                            </div>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?php echo htmlspecialchars($calif['maestro_nombre'] . ' ' . $calif['maestro_apellido']); ?></td>
                                        <td>
                                        ...
                                        <td>
                                            <?php if ($calif['comentarios']): ?>
                                                <small class="text-muted"><?php echo htmlspecialchars($calif['comentarios']); ?></small>
                                            <?php else: ?>
