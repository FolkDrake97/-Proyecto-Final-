...
<div class="row mb-4">
    <div class="col-12">
        <div class="card bg-primary text-white">
            <div class="card-body">
                <h2>¡Bienvenido, Profesor <?php echo obtenerNombreUsuario(); ?>! 👨‍🏫</h2>
                <p class="mb-0">Panel de control para gestionar tus materias y estudiantes</p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-3">
                        <a href="<?php echo BASE_URL; ?>/views/inscripciones/solicitudes.php" class="btn btn-outline-warning w-100 p-3">
                            <i class="fas fa-user-check fa-2x d-block mb-2"></i>
                            Solicitudes
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo BASE_URL; ?>/views/actividades/lista.php" class="btn btn-outline-info w-100 p-3">
                            <i class="fas fa-tasks fa-2x d-block mb-2"></i>
                            Actividades
                        </a>
                    </div>
                    <div class="col-md-3">
                        <a href="<?php echo BASE_URL; ?>/views/calificaciones/registrar.php" class="btn btn-outline-success w-100 p-3">
